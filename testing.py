...
def main():
    ...
    test_tweets = [
        "El Gobierno NO aprobó la financiación de 1 hora y 45 minutos en pensiones para los enfermos de ELA",
        "Me encanta el Resident Evil Requiem, me pase toda la noche jugando",
